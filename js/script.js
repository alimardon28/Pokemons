...
let newPokemonsCandyCount = document.createElement('p');
...
newPokemonsCandyCount.setAttribute('class' , 'pokemons__height fw-bold');
...
newPokemonsCandyCount.textContent = pokemon.candy_count;
newPokemonsTime.textContent = pokemon.spawn_time;
...
newCardBody.appendChild(newPokemonsCandyCount);
